...
function generate(){
	...
	for (let i = 0; i < NUM_COLS; i++){
		...
		cs.push([s_c[0] + c_c[0], s_c[1] + c_c[1], s_c[2] + c_c[2]]); // push rgb to list of colours
		document.getElementById(i).style.backgroundColor = `rgb(${cs[i][0]}, ${cs[i][1]}, ${cs[i][2]})`; // actually set the background colour of the column
		...
		var c_h = `#${h_c[0]}${h_c[1]}${h_c[2]}` // setting the current formatted hex colour
