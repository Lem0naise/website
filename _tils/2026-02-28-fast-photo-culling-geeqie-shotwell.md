...
1. Open up a directory of raw photos in Geeqie with the menu at the top left.
2. Use `SPACE` to go to the next photo, and `BACKSPACE` to go to the previous photo.
...
We want basic sliders (contrast, saturation, shadows, highlights).
