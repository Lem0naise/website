...
That's First Past the Post - the voting system behind the two most democratic countries in Europe: the United Kingdom, and Belarus[^1]. I am of course being unserious - having the same voting system as an authoritarian dictatorship is not something a single person in this country should be proud of.
...
The key to the German system however is the second vote. Any party that received at least 5 percent of the vote (electoral threshold) receives representation in the Bundestag, representative to the vote share they received[^6]. The local wins based on the first vote are then scaled using the second vote to attempt to increase proportionality and fairness.
...
The future of voting isn't just a political problem, in my view. It's design. And we deserve better design.[^12] [^13]

[^1]: <https://freedomhouse.org/country/belarus>
[^2]: <https://tactical.vote>
[^3]: <https://stopthetories.vote>
[^4]: <https://www.fairvote.ca/07/07/2024/uk-election-first-past-the-post/>
[^5]: <https://makevotesmatter.org.uk/>
[^6]: <https://en.wikipedia.org/wiki/Sainte-Lagu%C3%AB_method>
[^7]: <https://theconversation.com/wales-is-overhauling-its-democracy-heres-whats-changing-256640>
[^8]: <https://vote.nyc/page/ranked-choice-voting>
[^9]: <https://electoral-reform.org.uk/in-ireland-it-actually-feels-like-my-vote-makes-a-difference/>
[^10]: <https://post.parliament.uk/elections-and-their-reform/>
[^11]: <https://www.pewresearch.org/global/2024/03/13/electoral-reform-and-direct-democracy/>
[^12]: <https://electoral-reform.org.uk/>
[^13]: <https://makevotesmatter.org.uk/>
