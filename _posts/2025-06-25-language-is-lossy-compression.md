...
There is also the idea of high-context and low-context language cultures[^5]. European and American cultures are often described as low-context cultures - they expect communication to be explicit and direction. They try to cram as much data as possible into the compressed file, because the individual receiving it is expecting that. In contrast, cultures such as African and Arab and many Asian countries, rely more heavily on shared context, non-verbal clues and relationship backgrounds. The actual words may only form a small part of the message - it is assumed that both parties share a lot of 'metadata' about the conversation already, so the file can be smaller and still be understood.
